...
//3 max price range validation
if(price > maxPrice) return toast.error ('offer less or equal to maximum price')

//4  offered deadline within sellers validation
if(compareAsc(new Date(startDate),new Date(deadline))===1)
  return('offer a date within deadline')
const bidData={price,comment,email,deadline:startDate,jobId,title,category,status:'pending',buyer:buyer?.email}
