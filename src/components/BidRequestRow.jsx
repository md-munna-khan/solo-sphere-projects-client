...
const BidRequestRow = ({bid, handleStatusChange }) => {
        ...
        <td className='px-4 py-4 text-sm whitespace-nowrap'>
          ...
          <p
                          className={`px-3 py-1  
                            ...
                            ${category ==="Digital Marketing" ? 'text-green-500 bg-blue-100/60':''}
                            ${category ==="Graphics Design" ? 'text-red-500 bg-blue-100/60':''}
